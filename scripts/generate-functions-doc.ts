...
const FUNCTIONS: FunctionEntry[] = [
  ...
  {
    name: 'computeDashboardStats',
    type: 'onSchedule',
    file: 'caching/computeDashboardStats.ts',
    description: '1시간마다 SuperAdmin 대시보드용 통계(운행일지, 예약, 기관, 직원, 미래예약 등) 집계 후 system/dashboardTimeSeries에 캐싱',
    auth: '시스템 자동 실행',
    note: 'schedule: "every 1 hours", 메모리: 512MiB, 타임아웃: 300s',
  },
  {
    name: 'syncHolidaysScheduled',
    type: 'onSchedule',
    file: 'syncHolidays.ts',
    description: '공휴일 데이터를 공공데이터포털에서 주기적으로 동기화하여 Firestore에 저장',
    auth: '시스템 자동 실행',
    note: 'schedule: "0 6 * * *" (매일 오전 6시)',
  },
  {
