...
vi.mock('../../lib/firestore', () => ({
    ...
    getTodayReservations: (...args) => mockGetTodayReservations(...args),
    getWeekReservations: (...args) => mockGetWeekReservations(...args),
    updateReservationStatus: (...args) => mockUpdateReservationStatus(...args),
    cancelReservation: (...args) => mockCancelReservation(...args),
    getMyDriveLogs: (...args) => mockGetMyDriveLogs(...args),
}));
