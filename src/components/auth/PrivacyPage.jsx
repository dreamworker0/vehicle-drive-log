                    ...
                    <section className="space-y-3">
                        ...
                        <div className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed space-y-3">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
                                <p className="font-medium text-blue-800 mb-1">🔒 비밀번호 미저장</p>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed space-y-3">
                            <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                                <p className="font-medium text-amber-800 mb-2">📷 계기판 사진 처리</p>
                                <ul className="list-disc list-inside space-y-1 ml-2 text-amber-700 text-xs">
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                                <p className="font-medium text-amber-800 mb-2">📄 비영리 증빙서류 처리</p>
                                <ul className="list-disc list-inside space-y-1 ml-2 text-amber-700 text-xs">
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed space-y-3">
                            <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-3">
                                <p className="font-medium text-green-800 mb-2">🏢 데이터 소유</p>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed">
                            <div className="bg-purple-50 border border-purple-200 rounded-xl px-4 py-3">
                                <p className="font-medium text-purple-800 mb-2">👥 탑승자 이름 기록 원칙</p>
                                <ul className="list-disc list-inside space-y-1 ml-2 text-purple-700 text-xs">
