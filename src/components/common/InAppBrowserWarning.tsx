        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 px-4">
            <div className="relative w-full max-w-sm glass-card p-6 space-y-6 animate-scale-in">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-xl font-medium text-surface-700 dark:text-surface-300 hover:bg-surface-50 dark:hover:bg-surface-800/50 hover:shadow-md transition-all duration-200 active:scale-[0.98]"
                >
                    {copied ? (
                        <>
                ...
                <p className="text-xs text-surface-400 dark:text-surface-500 text-center leading-relaxed mt-2">
