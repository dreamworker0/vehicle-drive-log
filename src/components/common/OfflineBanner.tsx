    ...
    if (isOffline) {
        return (
            <div
                role="alert"
                aria-live="assertive"
                className="fixed top-0 left-0 right-0 z-[9999] bg-red-500 text-white text-center py-2 px-4 text-sm font-medium flex items-center justify-center gap-2 animate-fade-in"
            >
    ...
    if (showReconnected) {
        return (
            <div
                role="status"
                aria-live="polite"
                className="fixed top-0 left-0 right-0 z-[9999] bg-green-500 text-white text-center py-2 px-4 text-sm font-medium flex items-center justify-center gap-2 animate-fade-in"
            >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
