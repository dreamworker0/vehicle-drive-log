...
function ChartRecommendation({ recommendationStats, recommendationRatio }: Props) {
                ...
                <div className="mt-6">
                    <ResponsiveContainer width="100%" height={256} minWidth={1}>
                        <AreaChart data={recommendationStats} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
                            <defs>
                                <linearGradient id="colorNormalRec" x1="0" y1="0" x2="0" y2="1">
                            ...
                            <Area type="monotone" dataKey="normal" stackId="res" stroke="#3b82f6" strokeWidth={2} fill="url(#colorNormalRec)" />
    ...
    }, [recommendationStats, recommendationRatio]);

    return chartContent;
}

export default React.memo(ChartRecommendation);
