...
export default function OrgApplicationList({ onCountChange }) {
    ...
    // AI 재분석
    const handleAiReanalyze = async (app) => {
        ...
        try {
            const ocrResult = await ocrDocumentVerify(app.uniqueNumberImageUrl, app.name);
            await updateOrganization(app.id, {
