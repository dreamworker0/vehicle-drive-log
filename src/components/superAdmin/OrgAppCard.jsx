                        ...
                        {tab === 'rejected' && app.rejectedAt && (
                            <div className="sm:col-span-2">
                                ...
                                <span className="ml-2 text-surface-700 dark:text-surface-300">
                                    {app.rejectedAt?.toDate ? app.rejectedAt.toDate().toLocaleDateString('ko-KR') : new Date(app.rejectedAt).toLocaleDateString('ko-KR')}
                                </span>
                            </div>
                        )}
                        {app.createdAt && (
                            <div className="sm:col-span-2">
                                ...
                                <span className="ml-2 text-surface-700 dark:text-surface-300">
                                    {app.createdAt?.toDate
                                        ? app.createdAt.toDate().toLocaleString('ko-KR', { year: 'numeric', month: 'numeric', day: 'numeric', hour: '2-digit', minute: '2-digit' })
