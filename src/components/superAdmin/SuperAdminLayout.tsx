...
const OcrTestPage = lazyWithRetry(() => import('./OcrTestPage'));
                ...
                <header className="sticky top-0 z-30 bg-white/80 dark:bg-surface-900/80 backdrop-blur-md border-b border-surface-100 dark:border-surface-700 px-4 lg:px-6 h-14 flex items-center justify-between safe-top">
                    ...
                    <div className="flex items-center gap-1.5 mr-2">
                        <button
                            ...
                            className="py-1 px-2.5 rounded-lg text-xs font-medium bg-primary-50 text-primary-700 active:bg-primary-100 dark:bg-primary-900/40 dark:text-primary-300 dark:active:bg-primary-900/60"
                        >
                            🏢 관리자
                        </button>
                        <button
