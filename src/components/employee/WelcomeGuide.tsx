    ...
    return (
        <div className="glass-card border-2 border-primary-200 p-5 mb-5 animate-fade-in relative">
            <button aria-label="버튼"
                onClick={onDismiss}
                className="absolute top-3 right-3 p-1 rounded-lg text-surface-400 dark:text-surface-500 hover:text-surface-600 dark:hover:text-surface-300 hover:bg-surface-100 dark:hover:bg-surface-700 transition-colors min-w-[48px] min-h-[48px] flex items-center justify-center"
                title="닫기"
            >
            ...
            <div className="space-y-2.5 text-sm text-surface-600 dark:text-surface-400">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-surface-400 dark:text-surface-500">운행을 마치고 계기판 사진을 찰칵 찍으면 귀찮은 주행거리가 알아서 쏙 입력된답니다.</p>
                    </div>
                </div>
            </div>
        </div>
