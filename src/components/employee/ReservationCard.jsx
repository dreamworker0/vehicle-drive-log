...
const NAV_LABELS = { naver: '네이버', kakao: '카카오', tmap: '티맵' };
                ...
                <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                            <p className={`${isInProgress ? 'font-bold text-amber-900 dark:text-amber-200 text-base' : 'font-medium text-surface-800 dark:text-surface-200 text-sm'}`}>{reservation.vehicleName}</p>
                            ...
                            {reservation.routeDistance && (
                                <p className="text-xs text-blue-500 flex items-center gap-2 mt-0.5">
                                    ...
                                    {reservation.routeTollFee > 0 && <span>₩{reservation.routeTollFee.toLocaleString()}</span>}
                                </p>
                            )}
                        </div>
                    </div>
