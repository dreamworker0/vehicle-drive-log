                                        ...
                                        {expandedId === log.id && (
                                            <div className="px-4 pb-4 border-t border-surface-100 dark:border-surface-700 pt-3 animate-fade-in">
                                                <div className="grid grid-cols-2 gap-3 text-sm">
                                                    ...
                                                    {log.startLocation && (<div><span className="text-xs text-surface-400 dark:text-surface-500">출발지</span><p className="text-surface-700 dark:text-surface-300">🚩 {log.startLocation}</p></div>)}
