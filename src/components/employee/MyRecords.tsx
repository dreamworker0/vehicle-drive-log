                                        ...
                                        {expandedId === log.id && (
                                            <div className="px-4 pb-4 border-t border-surface-100 dark:border-surface-700 pt-3 animate-fade-in">
                                                ...
                                                <div className="flex gap-2 mt-3">
                                                    <button onClick={() => navigate('/employee/drive-log', { state: { continueFrom: log } })} className="btn-soft-primary flex-1 text-sm">
                                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
                                                        이어서 기록
                                                    </button>
