        ...
        <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="glass-card p-6 mb-6">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value={form.address} onChange={e => setForm({ ...form, address: e.target.value })} className="input" placeholder="기관 주소" required />
                    </div>
                    <div>
            ...
            <div className="glass-card p-6 mb-6">
                ...
                {form.approvalLine.length < 5 && (
                    <button
                        type="button"
                        onClick={() => setForm({ ...form, approvalLine: [...form.approvalLine, { title: '', name: '' }] })}
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between items-center p-3 bg-surface-50 dark:bg-surface-800 rounded-xl">
                        ...
                        <span className="text-surface-600 dark:text-surface-300">
                            {org?.createdAt?.toDate?.()?.toLocaleDateString('ko-KR') || '-'}
                        </span>
                    </div>
                </div>
            </div>
