...
export default function DriveLogList() {
    ...
    const [dupState, setDupState] = useState('idle'); // idle | scanning | result | cleaning
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={async () => {
                            ...
                            try {
                                ...
                                setDupResult(result);
                                setDupState(result.deleteCount > 0 ? 'result' : 'idle');
                    ...
                    <button
                        onClick={async () => {
                            ...
                            downloadDriveLogsExcel(filteredLogs, `운행일지_${period}`, {
                            ...
                            <button
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        showToast(`${result.deleteCount}건의 중복 데이터가 삭제되었습니다.`, 'success');
                                        setDupState('idle');
                                        setDupResult(null);
                                        // 목록 새로고침
                                        setLoading(true);
