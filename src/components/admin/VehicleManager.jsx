...
const FUEL_TYPE_LABELS = { gasoline: '휘발유', diesel: '경유', lpg: 'LPG', electric: '전기차' };
const FUEL_TYPE_COLORS = { gasoline: 'badge-primary', diesel: 'badge-neutral', lpg: 'badge-warning', electric: 'badge-success' };
...
export default function VehicleManager() {
    ...
    // 차량 카드 렌더링 함수
    const renderVehicleCard = (vehicle, isRetired = false) => (
