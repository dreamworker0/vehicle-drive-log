 ...
 */
export const snapMinutes = (mins) => Math.round(mins / SNAP_MINUTES) * SNAP_MINUTES;
 ...
 */
export const getPercent = (minutes) => {
 ...
 */
export const getGaps = (vReservations, isToday, nowSnapped) => {
    const gaps = [];
