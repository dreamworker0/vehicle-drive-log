 ...
 */
export default function useTimelineDrag(onSlotClick) {
    ...
    const clientXToMinutes = useCallback((clientX, vehicleId) => {
        const bar = barRefs.current[vehicleId];
    ...
    const handleDragStart = useCallback((e, vehicleId, gapStart, gapEnd) => {
        e.preventDefault();
