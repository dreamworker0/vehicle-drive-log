...
export default function useAnalytics() {
    ...
    useEffect(() => {
        ...
        const fetchAll = async () => {
            ...
            try {
                ...
                setLogs(l);
                setVehicles(v);
                setMembers(m.filter(u => u.role !== 'superAdmin'));
    ...
    const driverComparison = useMemo(() => {
        ...
        filteredLogs.forEach(l => {
            ...
            map[driver].months[mk].distance += (l.endKm - l.startKm) || 0;
            map[driver].totalCount++;
            map[driver].totalDistance += (l.endKm - l.startKm) || 0;
        });
    ...
    const fuelEfficiency = useMemo(() => {
        ...
        filteredLogs.forEach(l => {
            ...
            const dist = (l.endKm - l.startKm) || 0;
    ...
    const recommendations = useMemo(() => {
        ...
        maintenanceCostAnalysis.forEach(v => {
            ...
            // 마지막 정비 후 90일 이상 경과
            const daysSinceMaint = Math.floor((new Date() - new Date(v.lastMaintenanceDate)) / (1000 * 60 * 60 * 24));
