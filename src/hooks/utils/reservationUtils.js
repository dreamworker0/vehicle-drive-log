 ...
 * @returns {string}
 */
export const getMinStartTime = (isToday) => isToday ? getCurrentTimeStr() : '00:00';
 ...
 */
export function findOverlappingReservation(reservations, { vehicleId, date, startTime, endTime, excludeId = null }) {
 ...
 */
export function calcEndTime(startTime, durationMin = 0) {
 ...
 */
export function getAutoTimes(selectedDate, durationMin = 0) {
