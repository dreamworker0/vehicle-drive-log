...
<!-- AUTO-GENERATED — scripts/sync-claude-agents.ts가 .agent/skills/add-pwa-feature/SKILL.md에서 생성. 직접 수정 금지. -->

# add-pwa-feature

> 📄 **단일 원본**: [.agent/skills/add-pwa-feature/SKILL.md](../../../.agent/skills/add-pwa-feature/SKILL.md)
