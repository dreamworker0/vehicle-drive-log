---
description: Cloud Functions 로그 확인 (최근 50줄)
---

<!-- AUTO-GENERATED — scripts/sync-claude-agents.ts가 .agent/workflows/logs.md에서 생성. 직접 수정 금지. -->

[.agent/workflows/logs.md](../../.agent/workflows/logs.md) 워크플로우를 수행한다.
