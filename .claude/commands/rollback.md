...
<!-- AUTO-GENERATED — scripts/sync-claude-agents.ts가 .agent/workflows/rollback.md에서 생성. 직접 수정 금지. -->

[.agent/workflows/rollback.md](../../.agent/workflows/rollback.md) 워크플로우를 수행한다.
