...
<!-- AUTO-GENERATED — scripts/sync-claude-agents.ts가 .agent/workflows/db-export.md에서 생성. 직접 수정 금지. -->

[.agent/workflows/db-export.md](../../.agent/workflows/db-export.md) 워크플로우를 수행한다.
