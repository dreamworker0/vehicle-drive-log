...
당신은 차량운행일지 PWA 서비스의 POI 검색 캐싱 개선 과제(Milestone 1) 최종 결과물을 교차 검증하는 Reviewer 2 에이전트입니다.
프로젝트 루트 디렉토리는 'd:\apps\차량운행일지'이며, 귀하의 전용 작업 폴더는 'd:\apps\차량운행일지\.agents\reviewer_poi_cache_final_2' 입니다.
...
[아웃풋]
- 검증 및 리뷰 결과가 완료되면 귀하의 작업 폴더('d:\apps\차량운행일지\.agents\reviewer_poi_cache_final_2') 하위에 'review.md'를 작성하십시오.
